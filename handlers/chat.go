...
// Kita tambah field 'context' untuk data perangkat
...
func ChatHandler(w http.ResponseWriter, r *http.Request, model *genai.GenerativeModel) {
	...
	// 3. Bikin Prompt Khusus (System Prompt) dengan KONTEKS
	var systemInstruction string
	
	if req.Context != "" {
		// Kalau user milih perangkat, AI jadi konsultan spesifik
...
Batasan: Jawab maksimal 2-3 kalimat. Bahasa Indonesia santai & solutif.
`, req.Context)
	} else {
		// Kalau gak pilih perangkat (General)
		systemInstruction = `
Peran: Kamu adalah asisten energi "EnerTrack".
Tugas: Berikan tips hemat listrik umum.
